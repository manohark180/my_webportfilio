...
export default class projects extends Component {
  ...
  {this.state.active==0 && (<div className="row" 
     >
         <div className="col-sm-12">
             <div className="row">
                 <div className="col-sm-4" style={{padding:"7%"}}> <ScrollAnimation animateIn="bounceInLeft" >
    <div class="profile-card">
                ...
                <div class="profile-content">
                 ...
                 <div className="col-sm-4" style={{padding:"7%"}}><ScrollAnimation animateIn="slideInUp" ><div class="profile-card">
                <div class="profile-img">
                    <img src="./project2.jpg"  style={{height:"300px"}} alt="Team Image"/>
                </div>
                <div class="profile-content">
                 ...
                 <div className="col-sm-4" style={{padding:"7%"}}> <ScrollAnimation animateIn="bounceInRight" >
    <div class="profile-card">
                <div class="profile-img">
                    <img src="./project3.jpg" style={{height:"300px"}} alt="Team Image"/>
                </div>
                <div class="profile-content">
                    <h2 class="title">DLP
     ...
     >
         <div className="col-sm-12">
             <div className="row">
                     ...
                     <div className="col-sm-6" style={{padding:"7%"}}>
                     <ScrollAnimation animateIn="bounceInLeft" >
    <div class="profile-card">
                <div class="profile-img">
                    <img src="./application.jpg" style={{height:"300px"}} alt="project image"/>
                </div>
                <div class="profile-content">
                    <h2 class="title">Online Application for Supervisor
                     ...
                     <div className="col-sm-6" style={{padding:"7%"}}>
                     <ScrollAnimation animateIn="bounceInRight" ><div class="profile-card">
                <div class="profile-img">
                    <img src="./tracking.png"  style={{height:"300px"}} alt="Team Image"/>
                </div>
                <div class="profile-content">
                ...
                <div class="profile-content">
                    <h2 class="title">PIE
                        ...
                        <span><a href="https://pie.ccmrm.org/#/" style={{color:"black"}}>Platform for Invester Education</a></span>
                         ...
                         <div className="col-sm-6" style={{padding:"7%",lineHeight:"40px"}}>
